...
import { RideOptionsComponent } from '../../ride-options/ride-options2.component';
...
@Component({
  ...
  styleUrl: './book-ride-modal.component.css',
})
export class BookRideModalComponent implements OnInit {
  ...
  constructor(
    ...
    this.bookingForm = this.fb.group({
      ...
      customerId: [localStorage.getItem('authId'), Validators.required],
      driverId: ['963440ad-339e-49da-aeb3-432417ae8137']
    });
